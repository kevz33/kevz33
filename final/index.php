  ...
  session_start();
    ...
    switch($httpMethod) {
      ...
      case "GET":
        ...
        $whereSql = "SELECT p.*,s.name AS 'status_name', t.name AS 'type_name'
...
// Make it a associative array (by making second param = true)
        ...
        // Build the select statement (assuming the posted data has a field called dataFromPost)
        $whereSql = "
        INSERT INTO page (racerId, Date, start_time, location) VALUES (:racerId,:Date,:start_time, :location)
        ";
